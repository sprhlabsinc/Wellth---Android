...
public class FriendInviteAdapter extends ArrayAdapter<ParseUser> {
    private final Context mContext;
    private ArrayList<ParseUser> dataSet;

    public FriendInviteAdapter(ArrayList<ParseUser> data, Context context) {
        super(context, R.layout.list_adapter_friend_invite_cell, data);
        this.dataSet = data;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if(itemView == null) {
            ...
            itemView = (View)inflater.inflate(R.layout.list_adapter_friend_invite_cell, parent, false);
            ...
            holder.btn_invite = (Button) itemView.findViewById(R.id.btn_invite);
