...
public class FriendAdapter extends ArrayAdapter<ParseUser> {
    ...
    public FriendAdapter(ArrayList<ParseUser> data, Context context) {
        super(context, R.layout.list_adapter_friend_cell, data);
        this.dataSet = data;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if(itemView == null) {
            ...
            itemView = (View)inflater.inflate(R.layout.list_adapter_friend_cell, parent, false);
